...
//
//
//public class ChicagoAdapter extends ArrayAdapter<ChicagoClass> {
//    int quantity = 0;
//    int i = 0;
//    int value = 0;
//    String hold = "";
...
//        }
//
//        ChicagoClass currentChicagoItem = getItem(position);
//
//        ImageView imageView = listItemView.findViewById(R.id.item_image);
//        imageView.setImageResource(currentChicagoItem.getImageResourceId());
//
//        TextView nameTextView = listItemView.findViewById(R.id.item_name);
//        nameTextView.setText(currentChicagoItem.getItemName());
//
//        TextView priceTextView = listItemView.findViewById(R.id.item_price);
//        priceTextView.setText("Price " + currentChicagoItem.getItemPrice());
//
//
...
//
//
//        hold = currentChicagoItem.getItemquantity();
...
//                    if (pos == 0) {
//                        boolean isinserted = databaseHelper.addTripToTable("Cloud Gate Tour", String.valueOf(quantity), String.valueOf(550 * quantity));
//                        if (isinserted) {
...
//                    }
//                    if (pos == 1) {
//                        boolean isinserted = databaseHelper.addTripToTable("Art Institue of Chicago Tour", String.valueOf(quantity), String.valueOf(550 * quantity));
//                        if (isinserted) {
//                            int price = 1;
...
//                    }
//                    if (pos == 2) {
//                        boolean isinserted = databaseHelper.addTripToTable("Buckingham Fountain Tour", String.valueOf(quantity), String.valueOf(250 * quantity));
//                        if (isinserted) {
//                            int price = 1;
...
//                    if (pos == 3) {
//
//                        boolean isinserted = databaseHelper.addTripToTable("Jackson Park Tour", String.valueOf(quantity), String.valueOf(100 * quantity));
//                        if (isinserted) {
//                            int price = 1;
...
//
//                        boolean isinserted = databaseHelper.addTripToTable("Tribune Tower Tour", String.valueOf(quantity), String.valueOf(100 * quantity));
//                        if (isinserted) {
//                            int price = 1;
//                            order_details[i] = "Id " + counter + " Tour price " + 100 * quantity + " ";
//                            counter++;
