...
//                    if (pos == 0) {
//                        boolean isinserted = databaseHelper.addTripToTable("Franfort Trolley Tour", String.valueOf(quantity), String.valueOf(550 * quantity));
//                        if (isinserted) {
...
//                    }
//                    if (pos == 1) {
//                        boolean isinserted = databaseHelper.addTripToTable("The Muhammad Ali Center Tour", String.valueOf(quantity), String.valueOf(550 * quantity));
//                        if (isinserted) {
//                            int price = 1;
...
//                    }
//                    if (pos == 2) {
//                        boolean isinserted = databaseHelper.addTripToTable("The Old 502 Winery Tour", String.valueOf(quantity), String.valueOf(250 * quantity));
//                        if (isinserted) {
//                            int price = 1;
...
//                    if (pos == 3) {
//
//                        boolean isinserted = databaseHelper.addTripToTable("Fairmount Falls Tour", String.valueOf(quantity), String.valueOf(100 * quantity));
//                        if (isinserted) {
//                            int price = 1;
...
//
//                        boolean isinserted = databaseHelper.addTripToTable("The Howard Steamboat Museum Tour", String.valueOf(quantity), String.valueOf(100 * quantity));
//                        if (isinserted) {
//                            int price = 1;
//                            order_details[i] = "Id " + counter + " Tour price " + 100 * quantity + " ";
//                            counter++;
